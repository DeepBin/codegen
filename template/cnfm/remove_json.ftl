...
<body style="overflow-x:hidden;" ng-controller="ctrl" ht-load="get${class}Json?id=${r"${"}param.id}" ng-model="data">
	<form id="form-param-edit" action="#" name="form">
		<div>
			...
			<div class="row mt20">
				<div class="col-md-12 text-center mt20 buttons">
					...
					<button type="button" class="btn btn-info border-ra0 btn-lg plr-80" ng-click="saveForm('do${class}Remove')">
                    	删除
                	</button>
				</div>
			</div>
